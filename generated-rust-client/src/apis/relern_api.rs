...
pub async fn create_answer(
...
) -> Result<crate::models::Answer, Error<CreateAnswerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateAnswerError> =
...
pub async fn health(
    configuration: &configuration::Configuration,
) -> Result<crate::models::Health, Error<HealthError>> {
    let local_var_configuration = configuration;
...
pub async fn list_questions(
    configuration: &configuration::Configuration,
    limit: Option<i64>,
) -> Result<Vec<crate::models::Question>, Error<ListQuestionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListQuestionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
